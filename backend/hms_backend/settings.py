...
EMAIL_SENDER_DOMAIN = env('EMAIL_SENDER_DOMAIN', default='')
EMAIL_WELCOME_LOCAL_PART = env('EMAIL_WELCOME_LOCAL_PART', default='welcome')
EMAIL_SECURITY_LOCAL_PART = env('EMAIL_SECURITY_LOCAL_PART', default='security')
WELCOME_FROM_EMAIL = env('WELCOME_FROM_EMAIL', default='')
SECURITY_FROM_EMAIL = env('SECURITY_FROM_EMAIL', default='')
...
CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS = env.int(
    'CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS',
    default=60,
)
CELERY_OPERABILITY_INSPECT_TIMEOUT_SECONDS = env.float(
    'CELERY_OPERABILITY_INSPECT_TIMEOUT_SECONDS',
    default=0.5,
)
CELERY_OPERABILITY_REDIS_TIMEOUT_SECONDS = env.float(
    'CELERY_OPERABILITY_REDIS_TIMEOUT_SECONDS',
    default=0.25,
)
CELERY_OPERABILITY_CACHE_TTL_SECONDS = env.int(
    'CELERY_OPERABILITY_CACHE_TTL_SECONDS',
    default=max(90, CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS * 2),
)
CELERY_OPERABILITY_STALE_CACHE_TTL_SECONDS = env.int(
    'CELERY_OPERABILITY_STALE_CACHE_TTL_SECONDS',
    default=max(600, CELERY_OPERABILITY_CACHE_TTL_SECONDS * 4),
)
...
if CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS > 0:
    CELERY_BEAT_SCHEDULE['refresh-celery-operability-metrics'] = {
        'task': 'apps.core.tasks.refresh_celery_operability_metrics',
        'schedule': float(CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS),
        'options': {
            'expires': max(10, CELERY_OPERABILITY_REFRESH_INTERVAL_SECONDS - 5),
        },
    }
