"""
Celery tasks for the encounters app.
...
@shared_task(
    name='apps.encounters.tasks.sync_encounter_to_fhir',
    bind=True,
...
@shared_task(name='apps.encounters.tasks.sync_pending_encounters')
...
@shared_task(name='apps.encounters.tasks.close_stale_outpatient_encounters')
...
@shared_task(name='apps.encounters.tasks.close_stale_emergency_encounters')
...
@shared_task(name='apps.encounters.tasks.cleanup_encounters_daily')
