"""
FHIR Proxy models for Encounter, CareTeam, and Account resources.
"""
...
class CareTeamProxy:
    """
    Proxy for FHIR CareTeam resource.
    """
    @staticmethod
    def create(
        patient_id: str,
        ...
        """
        Create a new FHIR CareTeam resource.

        Args:
            patient_id: FHIR Patient resource ID
            practitioners: List of FHIR Practitioner resource IDs
            encounter_id: Optional FHIR Encounter resource ID
            role: Optional role of the care team

        Returns:
            The created FHIR CareTeam resource
        """
        # Look up patient name
        patient_name = "Unknown Patient"
        try:
        ...
        for practitioner_id in practitioners:
            ...
            careteam_data["participant"].append({
                "role": [
                    {
                        "text": "Primary care provider"
                    }
                ],
                "member": create_reference("Practitioner", practitioner_id, display=practitioner_name)
            })

        if encounter_id:
            careteam_data["encounter"] = create_reference("Encounter", encounter_id)

        if role:
            careteam_data["name"] = role

        return fhir_client.create_resource("CareTeam", careteam_data)

    @staticmethod
    def get(careteam_id: str) -> Dict[str, Any]:
        """
        Get a FHIR CareTeam resource by ID.

        Args:
            careteam_id: FHIR CareTeam resource ID

        Returns:
            The FHIR CareTeam resource
        """
        return fhir_client.get_resource("CareTeam", careteam_id)

    @staticmethod
    def update(
        careteam_id: str,
        status: Optional[str] = None,
        practitioners: Optional[List[str]] = None,
        role: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        Update a FHIR CareTeam resource.

        Args:
            careteam_id: FHIR CareTeam resource ID
            status: Optional new status
            practitioners: Optional new list of FHIR Practitioner resource IDs
            role: Optional new role

        Returns:
            The updated FHIR CareTeam resource
        """
        careteam = fhir_client.get_resource("CareTeam", careteam_id)
        ...
        return fhir_client.update_resource("CareTeam", careteam_id, careteam)

    @staticmethod
    def delete(careteam_id: str) -> Dict[str, Any]:
        """
        Delete a FHIR CareTeam resource.
        ...
        Returns:
            Empty dict or operation outcome
        """
        return fhir_client.delete_resource("CareTeam", careteam_id)

class AccountProxy:
    """
    Proxy for FHIR Account resource.
    """
    @staticmethod
    def create(
        patient_id: str,
        ...
        """
        Create a new FHIR Account resource.
        ...
        Returns:
            The created FHIR Account resource
        """
        # Look up patient name
        patient_name = "Unknown Patient"
        try:
        ...
        return fhir_client.create_resource("Account", account_data)

    @staticmethod
    def get(account_id: str) -> Dict[str, Any]:
        """
        Get a FHIR Account resource by ID.

        Args:
            account_id: FHIR Account resource ID

        Returns:
            The FHIR Account resource
        """
        return fhir_client.get_resource("Account", account_id)
    ...
    def update(
        ...
        """
        Update a FHIR Account resource.
        ...
        Returns:
            The updated FHIR Account resource
        """
        account = fhir_client.get_resource("Account", account_id)
        ...
        return fhir_client.update_resource("Account", account_id, account)

    @staticmethod
    def delete(account_id: str) -> Dict[str, Any]:
        """
        Delete a FHIR Account resource.
        ...
        Returns:
            Empty dict or operation outcome
        """
        return fhir_client.delete_resource("Account", account_id)
