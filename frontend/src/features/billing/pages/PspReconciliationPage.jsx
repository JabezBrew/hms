          ...
          <TabsContent value="intents" className="mt-6 space-y-6">
            <section className="bg-card border border-border rounded-2xl p-5 sm:p-6">
              ...
              {intents.length === 0 ? (
                ...
                <VirtualizedTable rows={intents} columns={intentColumns} threshold={50} />
              )}

              {intentPages > 1 && (
                <div className="flex items-center justify-between mt-4">
                  <p className="font-mono text-xs text-muted-foreground">
                    Page {intentPage} of {intentPages}
                  </p>
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="font-mono text-xs"
                      disabled={!intentsQuery.data?.next}
          ...
          <TabsContent value="settlements" className="mt-6 space-y-6">
            ...
            <section className="bg-card border border-border rounded-2xl p-5 sm:p-6">
              ...
              {settlementBatches.length === 0 ? (
                ...
                <VirtualizedTable rows={settlementBatches} columns={settlementColumns} threshold={50} />
              )}
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="font-mono text-xs"
                      disabled={!settlementsQuery.data?.next}
        ...
        <DialogContent className="max-w-4xl">
          ...
          <DialogFooter>
            <Button
              variant="outline"
              className="font-mono text-xs"
              onClick={() => setLinesDialog({ open: false, batch: null })}
            >
              Close
            </Button>
          </DialogFooter>
