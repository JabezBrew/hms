...
const TIER_CONTROLLED_ROUTE_REQUIREMENTS = [
  ...
  { path: '/patients', features: ['patient_registration'] },
  { path: '/patients/create', features: ['patient_registration'] },
  { path: '/patients/find-or-register', features: ['patient_registration'] },
  { path: '/patients/:id', features: ['patient_registration'] },
  { path: '/patients/:id/profile', features: ['patient_registration'] },
  { path: '/patients/my-patients', features: ['patient_chronicle'] },
  { path: '/patients/:id/chronicle', features: ['patient_chronicle'] },
  { path: '/patients/:id/chronicle/print', features: ['patient_chronicle'] },
