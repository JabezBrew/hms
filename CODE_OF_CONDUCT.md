...
We pledge to make participation in HMS a harassment-free experience for
...
- Focusing on what is best for patients, clinicians, and the community
...
reported to the maintainers via a private channel (see `SECURITY.md` for
private contact guidance — do not include PHI in any report). All complaints
